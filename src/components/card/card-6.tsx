...
export function Card6({
  ...
  return (
    ...
    >
      ...
      >
        <p
          className={`${isSmall ? 'text-[1.8rem]' : 'text-[2.4rem]'} tracking-1.25`}
        >
        ...
        <p
          className={`rounded-lg ${isSmall ? 'line-clamp-2 text-[2.4rem]' : 'line-clamp-3 text-[3rem]'} font-bold tracking-0.25`}
